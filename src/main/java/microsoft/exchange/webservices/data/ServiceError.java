...
public enum ServiceError {
	...
	/**
	 * The conversation action alwayscategorize or 
	 * alwaysmove or alwaysdelete has failed.
	 */
    ...
    /**
     * The request is valid but does not specify
     *  the correct server version in the
     * RequestServerVersion SOAP header.  Ensure that the 
     * RequestServerVersion SOAP header is
    ...
    /**
     * An object within a change description must 
     * contain one and only one property to modify.
     */
    ErrorIncorrectUpdatePropertyCount,
    ...
    /**
     * Attachment subfilters must have a single 
     * TextFilter on the display name only.
     */
    ErrorInvalidAttachmentSubfilterTextFilter,
    ...
    /**
     * One or more UserId parameters are invalid. Make
     *  sure that the PrimarySmtpAddress, Sid and
     * DisplayName properties refer to the same user when specified.
     */
    ErrorInvalidDelegateUserId,

    /**
     * An ExchangeImpersonation SOAP header must 
     * contain a user principal name, user SID, or
    ...
    /**
     * The original sender of the message (initiator 
     * field in the sharing metadata) is not
     * valid.
     */
 ...
 // ErrorInvalidId
    ...
    /**
     * The EWS Id is in EwsLegacyId format which is
     *  not supported by the Exchange version
     * specified by your request. Please use the 
     * ConvertId method to convert from EwsLegacyId 
     * to EwsId format.
     */
    ...
    /**
     * The message couldn't be sent because the sender's
     * submission quota was exceeded. Please
     * try again later.
     */
    ErrorSubmissionQuotaExceeded,
    ...
    /**
     * Access is denied. Only the subscription 
    ...
    /**
     * The StreamingSubscription was unsubscribed while 
     * the current connection was servicing it.
     */
    ErrorSubscriptionUnsubscribed,
    ...
    /**
     * The Client Access server version doesn't match 
     * the Mailbox server version of the resource
     * that was being accessed. To determine the correct
     *  URL to use to access the resource, use
    ...
    /**
     * The mailbox of the authenticating user and the
     *  mailbox of the resource being accessed
